	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage	: '/Content/Images/jquery.progressbar/progressbar.gif',						// boxImage : image around the progress bar
				barImage	: {
								0:	'/Content/Images/jquery.progressbar/progressbg_black.gif',
								5:	'/Content/Images/jquery.progressbar/progressbg_red.gif',
								20: '/Content/Images/jquery.progressbar/progressbg_yellow.gif',
								50: '/Content/Images/jquery.progressbar/progressbg_orange.gif',
								80: '/Content/Images/jquery.progressbar/progressbg_green.gif'
								//70: '/Content/Images/jquery.progressbar/progressbg_red.gif'
